  ...
  return (
    <>
      ...
      <button
        ...
        className="mt-6 inline-flex min-h-[44px] w-full items-center justify-center rounded-[4px] bg-accent px-5 py-3 text-sm font-semibold tracking-wide text-[#0e0e0e] transition-colors hover:bg-accent-dark disabled:opacity-60"
      >
        {etat === "loading" ? "Connexion…" : "Me connecter"}
      </button>
    </>
  );
}
