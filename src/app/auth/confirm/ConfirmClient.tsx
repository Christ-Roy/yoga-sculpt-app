  ...
  if (etat === "error") {
    return (
      <>
        ...
        <a
          href="/login"
          className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-[4px] border border-border bg-surface px-5 py-2.5 text-sm font-medium text-text transition-colors hover:border-accent/60 hover:bg-surface-2 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
  ...
  return (
    <>
      ...
      <button
        ...
        className="mt-6 inline-flex min-h-[44px] w-full items-center justify-center gap-2 rounded-[4px] bg-accent px-5 py-3 text-sm font-semibold tracking-wide text-[#0e0e0e] transition-colors hover:bg-accent-dark disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
      >
        {etat === "loading" ? (
          <>
            <Spinner />
